  ...
  const resultMsg = {
    0: {
      ...
      content:
        ...
        '정해진 원칙과 계획에 따라 분명하고, 체계적으로 일하기를 좋아하는군요. ' +
        '그래서 기계를 조작하거나, 계산적인 능력을 발휘하는데 흥미가 있겠네요!',
    },
    1: {
      title: '협업을 즐기는 창의적인 개발자',
      content:
        '창조적이고 변화를 선호하면서도 타인에 대한 이해심이 많은 당신!! ' +
        '새로운 아이디어를 생각하고 타인을 위한 사회적 서비스를 제공하는 일을 좋아하는군요.' +
        '그래서 사무적이고 기계적인 업무보다는 혁신적이고 대인 지향적인 업무에 흥미가 있겠네요!',
    },
    2: {
      title: '연구지향적이며 리더십도 지닌 개발자 ',
      content:
        '분석적이고 학구적이면서도 모험적이며 야심이 있는 당신!!' +
        ' 당신과 비슷한 성향을 보인 개발자는 지식의 개발과 습득을 좋아하면서도 진취적이고 목표 지향적인 일을 좋아하는군요. ' +
        '그래서 탐구적이고 분석적인 사고를 통해 기존에 없던 기술을 개발하는 업무에 흥미가 있으며 열정적인 성향으로 팀 내 성과를 발휘하겠네요!',
    },
  };
  const resultDevType = {
    0: {
      content:
        '새로운 기계, 기술 트랜드를 공부하는 성향은 반도체, 로봇, 네트워크, 임베디드 개발 직무에 관심도가 크기에 ' +
    ...
    1: {
      content:
        '혁신적이고 창의적인 성향은 기획, UX/UI, 프론트엔드 등과 같이 디자인, 심미안적인 개발 직무에 관심도가 크기에' +
        'UI/UX개발자, 프론트엔드 개발자로 일하고 있어요!!' +
        '또한 타인에 대한 이해심이 많은 성향은 배려와 소통을 통해 팀에 긍정적인 역할을 하고 소비자 중심의 사고를 하기에' +
        'IT 기업의 PM(Product Manager)으로 일하고 있어요!!',
    },
    2: {
      content:
        '전문성과 깊이 있는 연구를 추구하는 성향은 새로운 기술을 개발해 내거나 문제를 해결하는 개발 직무에 관심이 크기에' +
        '인공지능 개발자, 백엔드 개발자로 일하고 있어요!!' +
        '또한 진취적이고 열정적인 성향은 팀의 목표와 방향성을 제시하고 자신의 역할을 능동적으로 실행하기에' +
        '프로젝트 매니징에 관심이 많고, PM(Product Manager)으로 일하고 있어요!!',
    },
  };
